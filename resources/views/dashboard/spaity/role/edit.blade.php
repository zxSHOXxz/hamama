...
@section('title', 'تعديل الأدوار الوظيفية')
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" name="guard_name" style="width: 100%;" id="guard_name"
                                            ...
                                            <option value="admin" @if ($roles->guard_name == 'admin') selected @endif>مشرف
                                            </option>
                                            <option value="client" @if ($roles->guard_name == 'client') selected @endif>عميل
                                            </option>

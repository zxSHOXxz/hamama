...
<body class="hold-transition login-page">
    <div class="login-box" style="margin: 10% auto !important;">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <p class="login-box-msg">تبقى فقط خطوة واحدة لانشاء كلمة مرور جديدة
                </p>
                <form action="{{ route('password.update') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" name="email" class="form-control" value="{{ $request->email }}"
                            placeholder="الايميل" disabled hidden>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary btn-block"> تغيير </button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>

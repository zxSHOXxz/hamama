                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="first_name" class="form-control"
                                        id="first_name" value="{{ $admins->user->first_name}}" placeholder="أدخل اسم المشرف  ">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="last_name">الاسم الأخير  </label>
                                    <input type="text" name="last_name" class="form-control"
                                        id="last_name" value="{{$admins->user->last_name}}" placeholder="أدخل اسم المشرف  ">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" name="email" class="form-control"
                                        id="email" value="{{$admins->email}}" placeholder="أدخل ايميل المشرف  ">
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="mobile" class="form-control"
                                        id="mobile" value="{{$admins->user->mobile}}" placeholder="أدخل    ">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="mobile_2"> الرقم الثاني  </label>
                                    <input type="text" name="mobile_2" class="form-control"
                                        id="mobile_2" value="{{$admins->user->mobile_2}}" placeholder="أدخل رقم الجوال الثاني    ">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" name="date" class="form-control"
                                        id="date" value="{{$admins->user->date}}"  placeholder="أدخل ايميل المشرف  ">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="id_number"> رقم الهوية  </label>
                                    <input type="number" name="id_number" class="form-control"
                                        id="id_number" value="{{$admins->user->id_number}}"  placeholder="أدخل كلمة المرور   ">
                                </div>
                            </div>
